      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5 sm:px-8">
        ...
        >
          <Image
            ...
            className="h-8 sm:h-9 dark:invert"
          />
        </Link>
        ...
        <nav className="flex items-center gap-1 sm:gap-2" aria-label="Navigation principale">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3.5 py-2 text-sm font-semibold text-white transition-all hover:bg-emerald-500 active:scale-[0.97]"
          >
            {/* WhatsApp icon */}
            <svg
