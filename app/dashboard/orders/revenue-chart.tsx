...
export function RevenueChart({ series }: { series: RevenueChartSeries }) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
      ...
      {/* Chart */}
      <div className="-mx-5 px-5 overflow-x-auto pb-4 sm:mx-0 sm:px-0 sm:overflow-x-visible sm:pb-0 hide-scrollbar">
        <div className="flex items-end gap-1 h-44 min-w-[500px] sm:min-w-0">
          {data.map((bar, i) => {
