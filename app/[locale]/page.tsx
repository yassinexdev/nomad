          ...
          <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:py-32">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="relative">
                <div className="aspect-[4/3] overflow-hidden rounded-3xl bg-zinc-100 shadow-2xl shadow-zinc-300/30 dark:bg-zinc-900 dark:shadow-black/30">
                  <Image
                    src={image1}
                    alt={t("ariaLogo")}
                    fill
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {features.map((f, i) => (
                <div
                  key={i}
                  className="group rounded-2xl border border-zinc-200 bg-white p-6 transition-all hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-100/30 dark:border-zinc-800 dark:bg-zinc-900/60 dark:hover:border-emerald-800 dark:hover:shadow-emerald-900/10"
                >
                  <div className="mb-4 inline-flex items-center justify-center rounded-xl bg-emerald-50 p-3 text-emerald-600 transition-colors group-hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-400 dark:group-hover:bg-emerald-900/40">
                    {f.icon}
                  </div>
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4">
                      <span className="inline-flex items-center gap-1.5 rounded-xl bg-zinc-900 px-4 py-2 text-xs font-semibold text-white transition group-hover:bg-emerald-600 dark:bg-zinc-800 dark:group-hover:bg-emerald-600">
                        {t("shopNow")}
